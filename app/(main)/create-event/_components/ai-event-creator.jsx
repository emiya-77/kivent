    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">AI Event Creator</DialogTitle>
                    <DialogDescription>
                ...
                <div className="space-y-4">
                    <Textarea
                        ...
                        placeholder="Example: A tech meetup about React 19 for developers in Banani, Dhaka. It should cover new features like Actions and use hook improvements..."
                        rows={6}
